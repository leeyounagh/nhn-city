...
export interface BuildingDef {
  ...
  flat?: boolean; // 바닥 장식 — 타일 지면으로 렌더(위로 솟지 않음). deco 아닌 자재 건물(밭 등)에도 쓸 수 있다.
  category?: BuildingCategory; // 건설 팔레트 탭 분류 (없으면 core, 장식은 deco 필드로 별도 탭).
}

export type BuildingCategory = "core" | "commerce" | "tower" | "church" | "castle" | "arch" | "farm" | "military" | "forge" | "nature" | "field";
